...
namespace MarsRover.Core.Helpers
{
    ...
    {
        public static bool TryMoveForward(Coordinate plateauLowerCoordinate, Coordinate plateauUpperCoordinate, Position roverPosition, out Coordinate nextCoordinate)
        {
            ...
            bool isValidCoordinate = CoordinateHelper.IsValidCoordinate(plateauLowerCoordinate, plateauUpperCoordinate, calculatedCoordinate);
